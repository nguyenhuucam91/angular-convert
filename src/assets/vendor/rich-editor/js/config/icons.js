const ICONS = {
  ...
  ALIGN_TEXT_LEFT: "<i class='fa fa-align-left'></i>",

  ALIGN_TEXT_CENTER: "<i class='fa fa-align-center'></i>",

  ALIGN_TEXT_RIGHT: "<i class='fa fa-align-right'></i>",
  ...
  H2: "<svg width='15' height='16' viewBox='0 0 15 16' fill='none' xmlns='http://www.w3.org/2000/svg'>\
  ...
  H3: "<svg width='11' height='12' viewBox='0 0 11 12' fill='none' xmlns='http://www.w3.org/2000/svg'>\
  ...
  IMAGE_FIT: "<svg width='24' height='16' viewBox='0 0 24 16'>\
  <path d='M6 0H18V16H6V0Z'></path>\
  <path d='M0 0H2V16H0V0Z'></path>\
  <path d='M24 16H22V0H24V16Z'></path>\
  </svg>",

  IMAGE_FULL: "<svg width='32' height='16' viewBox='0 0 32 16'>\
  ...
  CAMERA: "<svg width='16' height='14' viewBox='0 0 16 14' fill='none' xmlns='http://www.w3.org/2000/svg'>\
  ...
  PLAY: "<svg width='13' height='14' viewBox='0 0 13 14' fill='none' xmlns='http://www.w3.org/2000/svg'>\
  ...
  HR: "<svg class='svg-icon-addon-hr' width='25' height='15'>\
        <g fill-rule='evenodd'>\
